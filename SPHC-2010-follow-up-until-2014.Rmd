---
title: "The Stockholm Public Health Cohort (SPHC) 2010, followed up to 2014"
...
d_2010_prelim <- d_2010 %>% 
  select( "sexual_identity_2010", "sexual_identity_2014", "identity_change", "age_2010", "sex", "country_of_birth", "income_2010", "antidepressant_use_2010", "anxiolytic_use_2010" )
summary( d_2010_prelim )
miss_var_summary( d_2010_prelim ) # 42.6% missing in identity_change, 41.2% in sexual_identity_2014, 3.8% in sexual_identity_2010
...
miss_var_summary( d_2010_selected ) # 46.4% missing in identity_change, 45.9% in sexual_identity_2014, 2.3% in sexual_identity_2010

# characteristics table
explanatory =  c( "sexual_identity_2014", "sex", "age_2010", "country_of_birth", "income_2010", "antidepressant_use_2010", "anxiolytic_use_2010" )
...
ggplot( d_2010_selected %>% filter( !is.na( sexual_identity_2010 ) & !is.na( sexual_identity_2014 ) ),
...
tab <- table( d_2010_selected$sexual_identity_2010, d_2010_selected$sexual_identity_2014 )
tab
( tab[ "Non-heterosexual", "Non-heterosexual" ] / sum( tab[ "Non-heterosexual", ] ) ) / 
  ( tab[ "Heterosexual", "Non-heterosexual" ] / sum( tab[ "Heterosexual", ] ) ) # RR = 20.2
...
tab <- table( d_2010_selected$sexual_identity_2010, is.na( d_2010_selected$sexual_identity_2014 ) )
tab
( tab[ "Non-heterosexual", "TRUE" ] / sum( tab[ "Non-heterosexual", ] ) ) / 
  ( tab[ "Heterosexual", "TRUE" ] / sum( tab[ "Heterosexual", ] ) ) # RR = 1.07
...
# correlation of income and sexual identity in 2014
ggplot( d_2010_selected %>% filter( !is.na( sexual_identity_2014 ) ),
        aes( x = income_2010, fill = sexual_identity_2014 ) ) +
  geom_bar( position = "fill" ) +
  scale_y_continuous( labels = scales::percent ) +
...
# correlation of income and missingness of sexual identity in 2014
ggplot( d_2010_selected,
        aes( x = income_2010, fill = is.na( sexual_identity_2014 ) ) ) +
  geom_bar( position = "fill" ) +
  scale_y_continuous( labels = scales::percent ) +
  labs( x = "Income (100 SEK/Year)", y = "Percentage", fill = "Missingness of Sexual Identity in 2014" ) +
  theme_classic()
...
# correlation of mental health and missingness of sexual identity in 2014
ggplot( d_2010_selected,
        aes( x = antidepressant_use_2010, fill = is.na( sexual_identity_2014 ) ) ) +
  geom_bar( position = "fill" ) +
  scale_y_continuous( labels = scales::percent ) +
  labs( x = "Antidepressant Use", y = "Percentage", fill = "Missingness of Sexual Identity in 2014" ) +
  theme_classic()

tab <- table( d_2010_selected$antidepressant_use_2010, is.na( d_2010_selected$sexual_identity_2014 ) )
tab
( tab[ "Yes", "TRUE" ] / sum( tab[ "Yes", ] ) ) / 
  ( tab[ "No", "TRUE" ] / sum( tab[ "No", ] ) ) # RR = 1.05

ggplot( d_2010_selected,
        aes( x = anxiolytic_use_2010, fill = is.na( sexual_identity_2014 ) ) ) +
  geom_bar( position = "fill" ) +
  scale_y_continuous( labels = scales::percent ) +
  labs( x = "Anxiolytic Use", y = "Percentage", fill = "Missingness of Sexual Identity in 2014" ) +
  theme_classic()

tab <- table( d_2010_selected$anxiolytic_use_2010, is.na( d_2010_selected$sexual_identity_2014 ) )
tab
( tab[ "Yes", "TRUE" ] / sum( tab[ "Yes", ] ) ) / 
...
impute_data_3 <- d_2010_selected_female %>%
  select( sexual_identity_2010, sexual_identity_2014, age_2010, country_of_birth, income_2010 )
...
impute_data_4 <- d_2010_selected_female %>%
  select( sexual_identity_2010, sexual_identity_2014, age_2010, country_of_birth, antidepressant_use_2010, anxiolytic_use_2010 )
...
impute_data_5 <- d_2010_selected_female %>%
  select( sexual_identity_2010, sexual_identity_2014, age_2010, country_of_birth, income_2010, antidepressant_use_2010, anxiolytic_use_2010 )
